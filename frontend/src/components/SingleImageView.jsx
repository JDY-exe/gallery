...
export function SingleImageView({
  ...
  return (
    <div className="relative w-full h-full overflow-hidden px-4 pt-20 pb-6 md:px-12 md:pt-24 md:pb-8">
      <div className="relative mx-auto flex w-full h-full max-w-7xl min-h-0 flex-col">
        {/* Main Image Area */}
        ...
        <div className="mt-4 grid grid-cols-[1fr_auto_1fr] items-end gap-4">
          ...
          <MotionDiv
            ...
            className="text-center max-w-xl justify-self-center"
          >
          ...
          <div className="justify-self-end self-end font-mono text-xs text-gray-500 tracking-widest">
